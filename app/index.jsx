...
export default function HomeScreen() {
  ...
  const handleLocations = async () => {
    const res = await fetchLocations("london").then((data) => {
      
      //console.log('DU LIEU TRA VE',data)
      setLocations(data);
      setLoading(false);
    });
    //console.log('SET VAO LOCATIONS',locations)
  };
          ...
          loading?(<View style={{alignItems:'center',flex:1,justifyContent:'center'}}>
            ...
            >
              ...
              >
                ...
                >
                  <Feather name="wind" color={"gainsboro"} size={20}></Feather>
                  <Text
                    style={{
                      paddingHorizontal: 2,
                      color: "gainsboro",
                ...
                >
                  <Ionicons name="water" color={"gainsboro"} size={20}></Ionicons>
                  <Text
                    style={{
                      paddingHorizontal: 2,
                      color: "gainsboro",
                ...
                >
                  <Ionicons name="sunny" color={"gainsboro"} size={20}></Ionicons>
                  <Text
                    style={{
                      paddingHorizontal: 2,
                      color: "gainsboro",
            ...
            <View style={{ marginBottom: 20 }}>
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Ionicons size={20} name="calendar" color={"white"}></Ionicons>
                <Text
                  style={{ paddingHorizontal: 5, fontSize: 18, color: "white" }}
                >
                  Daily forecast
                </Text>
              </View>
